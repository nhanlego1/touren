...
<?php endif;?>
 <?php if (!isset($_POST['to_step_2']) && !isset($_POST['to_step_3']) && !isset($_GET['amount'])):?>
                ...
                <form action="<?php echo esc_url(home_url('/'));?>tour_entry/" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<input type="hidden" name="to_step_2" value="yes">
                ...
                <tbody><tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="t5nm" required name="t5nm" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Tour theme<em class="required">※</em></th>
                    <td>
                        ...
                        <span id="c5kv" class="checkbox">
                            <label for="c5kv0"><input type="checkbox" id="c5kv0" name="c5kv[]" value="Gourmet">Gourmet</label>
                            <label for="c5kv1"><input type="checkbox" id="c5kv1" name="c5kv[]" value="Watching Sports · Experience">Watching Sports · Experience</label>
                            ...
                            <label for="c5kv4"><input type="checkbox" id="c5kv4" name="c5kv[]" value="Show · Entertainment">Show · Entertainment</label>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="t0gb" required name="t0gb" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Target age<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t6en" required name="t6en" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Tour fee<em class="required">※</em></th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="t2xk" required name="t2xk" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Supported languages<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t6ki" required name="t6ki" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Presence of meals<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t5gn" required name="t5gn" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Pick up or not<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t0fd" required name="t0fd" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Holidays<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t0mi" required name="t0mi" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Minimum performers<em class="required">※</em></th>
                    <td>
                        ...
                        <input type="text" id="t5lx" required name="t5lx" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Notes<em class="required">※</em></th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="t8ro" required name="t8ro" size="60" value="" maxlength="300">
                    </td>
                </tr>
                <tr>
                    <th>Street address<em class="required">※</em></th>
                    <td>
                        <span class="lside">Postal code</span><input type="number" id="t5kf" name="t5kf" size="3" style="height: 25px;" value="" required maxlength="3" oninput="maxLengthCheck3(this)"><span class="rside">-</span><input type="number" id="t3hz" style="height: 25px;" name="t3hz" size="4" value="" required maxlength="4" oninput="maxLengthCheck4(this)"><br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" required id="t4my" name="t4my" size="60" value="" oninput="maxLengthCheck12(this)" maxlength="12"><br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" required id="t0qm" name="t0qm" size="60" value="" maxlength="300"><br>
                ...
                <tr>
                    <th>Cellphone number<em class="required">※</em></th>
                    <td>
                        <input type="number" required style="height: 25px;" id="t4cf" name="t4cf" size="60" value="" maxlength="11" oninput="maxLengthCheck12(this)"><br>
