                            ...
                            <table summary="Confirmation contents">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Profile (Please write in interpretable language.): <?php echo $_POST['t3mp']; ?>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="lside">Postal code </span><input type="number" required
                                                                                      ...
                                                                                      id="t3gq" style="height: 25px;"
                                                                                      name="t3gq" size="4" value=""
                                                                                      max="999"><span
                                            class="rside">-</span><input type="number" style="height: 25px;" required
                                                                         maxlength="4" id="t0sz" name="t0sz" size="7"
                                                                         oninput="maxLengthCheck4(this)" value=""
                                                                         max="9999"><br>
                                        <span class="lside">Prefectures </span><select id="s5bo" required name="s5bo"
                                                                                       size="1">
                                            <option value="">----</option>
                                            <optgroup label="北海道">
                                        ...
                                        <span class="lside">Municipality </span><input type="text" required id="t4ii"
                                                                                       name="t4ii" size="60" value=""
                                                                                       maxlength="300"><br>
                                        <span class="lside">Street address building </span><input type="text" required
                                                                                                  id="t0pi" name="t0pi"
                                                                                                  size="60" value=""
                                                                                                  maxlength="300">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="tel" id="t0fl" name="t0fl" required style="height: 25px;" size="60"
