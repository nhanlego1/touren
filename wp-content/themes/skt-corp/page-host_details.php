...
<div class="pay"><a href="../host_entry/">Pay with PAYPAL</a></div>
          ...
          <table class="table table-striped course_table">
                <thead>
                  <tr>          
                    <th colspan="7" style="border: 1px solid #d4d2d2; color: #333;">| 過去の評価</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>          
