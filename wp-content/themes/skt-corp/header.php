...
<head>
    ...
    <link href="<?php echo esc_url(home_url('/')); ?>bootstrap-3.3.6/dist/css/bootstrap.min.css" rel="stylesheet"
          type="text/css">
    <script type="text/javascript" src="<?php echo esc_url(home_url('/')); ?>js/jquery.min.js"></script>
    <script src="<?php echo esc_url(home_url('/')); ?>bootstrap-3.3.6/dist/js/bootstrap.js"
...
<div class="wrapper_main <?php if (of_get_option('layout', true) != 'box') {
    echo 'layout_wide';
} else {
    echo 'layout_box';
} ?>">
        ...
        <div class="container">
            ...
            <div class="header_right">
                ...
                <div class="language">
                    ...
                    <a href="http://touren.exo-maker.com"><img
                            src="<?php echo esc_url(home_url('/')); ?>english.png"></a>
                </div>
            </div>
            <div class="clear"></div>
        </div>
            ...
            if ($slAr > 0) {
                ...
                <div class="slider-wrapper theme-default">
                    <div id="slider" class="nivoSlider">
                        <?php
                        foreach ($slAr as $sv) {
                            $n++; ?><img src="<?php echo $sv['image_src']; ?>" alt="<?php echo $sv['image_title']; ?>"
                                         title="<?php if (($sv['image_title'] != '') && ($sv['image_desc'] != '')) {
                                             echo '#slidecaption' . $n;
                                         } ?>" /><?php
                            $slideno[] = $n;
                        }
                    ...
                    <div id="slidecaption<?php echo $sln; ?>" class="nivo-html-caption">
                        ...
                        if (of_get_option('slideurl' . $sln, true) != '') { ?>
                            <div class="slide_more"><a
                                href="<?php echo esc_url(of_get_option('slideurl' . $sln, true)); ?>"><?php _e('View More', 'skt-corp'); ?></a>
                            </div><?php
                        } ?>
                        </div><?php
                    } ?>
