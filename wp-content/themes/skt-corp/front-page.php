            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 tab_left">
                    <div class="aboutus_area wow fadeInLeft animated"
                        ...
                        <p class="bg_red">Japan Travel Guide.navi is a matching portal site for interpreting guides
                            (hosts) that will guide you to Japan, visiting foreigners (guests) and your "home town" or
                            "town".
                            ...
                            It is a site for everyone who is such a foreigner. The host will help you travel in Japan
                            with a sense of friends.Also, we will tie up with travel agencies and local governments to
                            introduce experiential tours and activities as well as "Japan is the only thing you can only
                            experience in Japan".
                            In addition, we have also introduced guest houses (guest houses) to foreigners who said "I
                            do not have a lodging place!" Though I came to Japan with great pains. Currently, lodging in
                            Japan is short. In particular, lack of accommodation in the metropolitan area such as
                            "Tokyo, Osaka, Nagoya" is serious. Japan Travel Guide.navi also provides information on
                            lodging alternatives to hotels and inns.
                    ...
                    <div class="newsfeed_area wow fadeInRight animated"
                        ...
                        <div class="tab-content bg_red_tab">
                            ...
                            <div id="notice" class="tab-pane fade active in">
                                ...
                                <a class="see_all" href="<?php echo esc_url(home_url('/')); ?>/category/achive/">See
                                    All</a>
                            </div>
                            ...
                            <div id="news" class="tab-pane fade">
                                ...
                                <a class="see_all" href="<?php echo esc_url(home_url('/')); ?>/category/news/">See
                                    All</a>
                            ...
                            <div id="events" class="tab-pane fade">
                                ...
                                <a class="see_all" href="<?php echo esc_url(home_url('/')); ?>/category/events/">See
                                    All</a>
        ...
        <div class="container">
            ...
            <div class="row margin-top-45">
                <div class="col-xs-12 col-sm-6 col-md-3 service-wrap">
                    ...
                    <p class="service-detail">Japan Travel Guide. A guide (host) that can interpret from all over Japan
                        is registered in navi. Like a friend, I will show you the city and the countryside where I live
                        easily. Although the guide (host) is not a professional, feeling with friends, feel free!
                        Happily! I will show you the foreigners who are visiting Japan. Please look for a nice host and
                        enjoy the journey of Japan full of charm.</p>

                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 service-wrap">
                    <div class="text-center"><img src="service-2.png"/></div>
                    <p class="service-title">Local tour information</p>
                    <p class="service-detail">T Japan Travel Guide.navi delivers experiential tours unique to Japan that
                        never can be experienced in sightseeing tours and packaged tours, and spot information not on
                        the guidebook. In addition, it is also possible to announce fully custom made to meet your
                        request.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 service-wrap">
                    ...
                    <p class="service-detail">In addition to staying accommodation where you can experience homestay in
                        the guide (host) home and villa and Japanese country life life, vacancy like air bnb (Air B &
                        B), vacant house information is also available, Tokyo and Osaka When staying in the metropolitan
                        area, the hotel and the inn is already full and I can not find the accommodation destination!
                        Take a peek at the Japan Travel Guide .navi.</p>

                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 service-wrap">
                    <div class="text-center"><img src="service-4.png"/></div>
                    <p class="service-title">Gourmet information</p>
                    <p class="service-detail">"Japanese food = Japanese food" chosen as the intangible cultural heritage
                        of UNESCO is not just sushi, tempura, ramen. There is plenty of gourmet in Japan food guide,
                        still more "cheap! Delicious! Japan Travel Guide.navi has partnered with a gourmet site"
                        Taberkot "for foreigners visiting Japan, cheap in Japan! delicious! Japanese food information is
                        provided.</p>
