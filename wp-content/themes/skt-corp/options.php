...
//end 3
	...
	//9
	$options[] = array(
		'name' => __('Slider Image 9', 'skt-corp'),
		'desc' => __('Upload / select image for slide 9', 'skt-corp'),
		'id' => 'slide9',
		'class' => '',
		'std' => '',
		'type' => 'upload');
	...
	$options[] = array(
		'desc' => __('Title 9', 'skt-corp'),
		'id' => 'slidetitle9',
		'std' => 'Easy to Use',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Descrition 9', 'skt-corp'),
		'id' => 'slidedesc9',
		'std' => 'Nulla nunc purus, interdum quis imperdiet in, placerat id felis. Duis sodales iaculis mauris. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut leo augue, posuere id commodo quis, malesuada in justo.',
		'type' => 'textarea');			
		
	$options[] = array(
		'desc' => __('Link / Url 9', 'skt-corp'),
		'id' => 'slideurl9',
		'std' => '#link9',
		'type' => 'text',
		'subtype' => 'url');
